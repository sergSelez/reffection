      ...
      <div className="container">
        <div className="error_page_wrap">
          ...
          <div className="error_page_wrap-text typ_text onest">
            <p>
              Мы не можем найти страницу, которую вы искали. Возможно, она была удалена, переехала или никогда не
              существовала.
            </p>
          </div>
          <Link href={'/'} className="error_page_wrap-link btn gray light_gray">
            на главную
          </Link>
        </div>
      </div>
