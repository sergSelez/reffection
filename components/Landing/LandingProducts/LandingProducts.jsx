                ...
                <SwiperSlide className="landing_products_slider_sw_item" key={nanoid()}>
                  <div className="landing_products_slider_sw_item_head">
                    {item.iconIsImage ? (
                      ...
                      <div
                        className="landing_products_slider_sw_item_head-icon"
                        dangerouslySetInnerHTML={{ __html: item.headIcon }}
                      />
                    )}
                  ...
                  <div className="landing_products_slider_sw_item_body">
                    {item.iconIsImage ? (
                      ...
                      <div
                        className="landing_products_slider_sw_item_body-model"
                        dangerouslySetInnerHTML={{ __html: item.image }}
                      />
                    )}
                    <h3 className="landing_products_slider_sw_item_body-title">{item.title}</h3>
