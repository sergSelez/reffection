    ...
    <section className="product_page_work">
      <div className="product_page_work_wrap">
        <SectionHead>
          ...
          <SectionHeadTitlte className={'white'}>{dataWork.sectionTitle}</SectionHeadTitlte>
        </SectionHead>
            ...
            {dataWork.list.map((item, index) => (
              <SwiperSlide className="product_page_work_wrap_slider_sw_item" key={nanoid()}>
                <div className="product_page_work_wrap_slider_sw_item_top">
                  <div className="product_page_work_wrap_slider_sw_item_top-num">{index + 1}</div>
                  <h3 className="product_page_work_wrap_slider_sw_item_top-title">{item.title}</h3>
                </div>
                <div className="product_page_work_wrap_slider_sw_item_body">
                  <div
                    className="product_page_work_wrap_slider_sw_item_body-text"
