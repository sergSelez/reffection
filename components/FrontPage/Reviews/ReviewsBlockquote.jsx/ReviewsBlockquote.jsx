...
function ReviewsBlockquote({ className, content }) {
  ...
  return (
    <div className="container">
      <div
        className={`reviews_blockquote ${startAnimate ? 'active' : ''} ${className ? className : ''}`}
        ref={thisBlockRef}
      >
        <div className="row">
              ...
              <div className="reviews_blockquote_content_it">
                <div className="reviews_blockquote_content_it-line">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1338" height="202" viewBox="0 0 1338 202" fill="none">
                    <path
                      d="M1337 201V31C1337 14.4315 1323.57 1 1307 1L0.999944 1"
                      stroke="url(#paint0_linear_332_65644)"
                      strokeWidth="2"
                      strokeLinecap="round"
                ...
                <div className="reviews_blockquote_content_it-title section_title">{content?.title}</div>
          ...
          <div className="col-xl-2">
            <div className="reviews_blockquote_author">
              <div className="reviews_blockquote_author-image">
                {content?.author.img && <img src={content?.author.img} alt={content?.author.name} />}
              </div>
              <CustomText className="reviews_blockquote_author-info">
                {content?.author?.name && <p>{content?.author.name}</p>}
                {content?.author?.job && <p>{content?.author.job}</p>}
              </CustomText>
            </div>
          </div>
        </div>
        <div className="reviews_blockquote-line">
          <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="202" viewBox="0 0 1682 202" fill="none">
            <path
              d="M1 0.999993V171C1 187.569 14.4315 201 31 201H1681"
              stroke="#E8E8EB"
              strokeWidth="2"
              strokeLinecap="round"
              className="svg-elem-1"
