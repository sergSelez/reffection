  ...
  return (
    <section className={`rev_client ${className ? className : ''}`}>
      <div className="container">
        <SectionHead>
          <SectionHeadIcon>
            <svg xmlns="http://www.w3.org/2000/svg" width={62} height={62} viewBox="0 0 62 62" fill="none">
              ...
              <path
                d="M27 24.6471H21.6667C20.1939 24.6471 19 25.9112 19 27.4706V40.1765C19 41.7359 20.1939 43 21.6667 43H40.3333C41.8061 43 43 41.7359 43 40.1765V27.4706C43 25.9112 41.8061 24.6471 40.3333 24.6471H35M27 24.6471V21.8235C27 20.2641 28.1939 19 29.6667 19H32.3333C33.8061 19 35 20.2641 35 21.8235V24.6471M27 24.6471H35"
                stroke="#C9C9C9"
                strokeWidth={2}
                strokeLinecap="round"
          ...
          <SectionHeadTitlte>{titleSection ? titleSection : 'Отзывы клиентов'}</SectionHeadTitlte>
        </SectionHead>
              ...
              <SwiperSlide className="rev_client_wrap_sw_item" key={nanoid()}>
                ...
                <div className="rev_client_wrap_sw_item_content">
                  <div className="rev_client_wrap_sw_item_content_wrap">
                    {item.title && <div className="rev_client_wrap_sw_item_content-title">{item.title}</div>}
                    <div
                      className="rev_client_wrap_sw_item_content-text"
        ...
        {dataBenefit && <ReviewBenefit className={className} dataBenefit={dataBenefit} />}
      </div>
    </section>
  );
}
