      ...
      <div className="remodal_wrap">
        ...
        <div className={'icon'}>
          <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 54 54" fill="none">
            <path
              d="M19.5 36.9999C21.626 38.5757 24.2115 39.4999 27 39.4999C29.7885 39.4999 32.374 38.5757 34.5 36.9999"
              stroke="#006AFE"
              strokeWidth="3"
              strokeLinecap="round"
            />
            ...
            />
            <path
              d="M52 32C52 41.428 52 46.1422 49.071 49.071C46.1423 52 41.428 52 32 52"
              stroke="#006AFE"
              strokeWidth="3"
              strokeLinecap="round"
            />
            <path
              d="M22 52C12.5719 52 7.85789 52 4.92893 49.071C2 46.1422 2 41.428 2 32"
              stroke="#006AFE"
              strokeWidth="3"
              strokeLinecap="round"
            />
        ...
        <div className={'title_block'}>{formTitle ? formTitle : 'Оставить заявку'}</div>
    ...
    <div className={'remodal error'}>
      <div className="remodal_wrap">
        ...
        <div className={'icon'}>
          <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 54 54" fill="none">
            <path
              d="M19.5 39.4999C21.626 37.9242 24.2115 36.9999 27 36.9999C29.7885 36.9999 32.374 37.9242 34.5 39.4999"
              stroke="#006AFE"
              strokeWidth="3"
              strokeLinecap="round"
            />
            ...
            />
            <path
              d="M52 31.9999C52 41.428 52 46.1422 49.071 49.071C46.1423 52 41.428 52 32 52"
              stroke="#006AFE"
              strokeWidth="3"
              strokeLinecap="round"
            />
            <path
              d="M22 52C12.5719 52 7.85789 52 4.92893 49.071C2 46.1422 2 41.428 2 31.9999"
              stroke="#006AFE"
              strokeWidth="3"
              strokeLinecap="round"
            />
...
function FormModal({ isOpen, onRequestClose, formTitle, calculatorData, goalName }) {
  ...
  return (
    ...
    >
      ...
      {modalType === 'success' && <FormModalSuccess onRequestClose={handleClose} />}
      {modalType === 'error' && <FormModalError onRequestClose={handleClose} />}
      {modalType === 'loading' && <FormModalLoading onRequestClose={handleClose} formTitle={formTitle} />}
    </Modal>
  );
}
