  ...
  return (
    <div className={`services_page-package_modal ${isOpen ? 'active' : ''}`} onClick={handleOverlayClick}>
      <div className="services_page-package_modal-wrap">
        <div className="services_page-package_modal-title">Ежемесячные пакеты услуг</div>
          ...
          {packagesdata.packages.map((item, index) => (
            <div className="col-xl-3" key={index}>
              <div className="services_page-package_modal-item">
                <div className="services_page-package_modal-item_head" ref={(el) => (headRefs.current[index] = el)}>
                  <div className="services_page-package_modal-item_head-title">{item.head.title}</div>
                  <div className="services_page-package_modal-item_head-text">
                    <p>{item.head.subtitle}</p>
                  </div>
                  <div className="services_page-package_modal-item_head-cost">{item.head.price}</div>
        ...
        <button
          ...
          className="services_page-package_modal-close"
          onClick={handleClose}
        >
